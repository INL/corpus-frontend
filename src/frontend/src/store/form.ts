...
const privateActions = {
	initFilter: b.commit((state, payload: FilterField) => Vue.set(state.filters, payload.id, payload), 'filter_init'),
	initAnnotation: b.commit((state, payload: PropertyField) => Vue.set(state.pattern.simple.annotationValues, payload.id, payload), 'annotation_init'),
};
