...
// Copy of velocity WebappResourceLoader, but using jakarta.servlet instead of javax.servlet.
// Velocity will be dropped eventually and replaced by clientside rendering in Vue.
